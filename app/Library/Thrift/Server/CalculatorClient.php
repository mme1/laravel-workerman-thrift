...
class CalculatorClient implements \App\Library\Thrift\Server\CalculatorIf
{
    ...
    public function recv_calculate()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\App\Library\Thrift\Server\Calculator_calculate_result',
    ...
    public function recv_echoString()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\App\Library\Thrift\Server\Calculator_echoString_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
